...
public class PublicMethodDeclaration {
	...
	public PublicMethodDeclaration(Type type, Identifier identifier, VarDeclaration varDeclarations, Statement ArrayList<Statement> statements, Expression expression){
		this.type = type ;
