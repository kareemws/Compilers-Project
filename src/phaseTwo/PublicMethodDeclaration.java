...
public class PublicMethodDeclaration implements MethodDeclaration{
	...
	public PublicMethodDeclaration(Type type, Identifier identifier, ArrayList<Type> types, ArrayList<Identifier> identifiers,ArrayList<VarDeclaration> varDeclarations,ArrayList<Statement> statements, Expression expression){
		this.type = type ;
